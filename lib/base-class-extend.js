...
$pr((getProto ? '': '!') + 'getProto');
$pr((setProto ? '': '!') + 'setProto');
...
$pr((Object.getOwnPropertyNames ? '': '!') + 'Object.getOwnPropertyNames');
  // copy
  var copy = defProp ?
      ...
      if (from) {
        ...
        for (var j = 0, m = props.length; j < m; ++j) {
          ...
          if (!base.hasOwnProperty(prop) &&
              ...
              base[prop] !== from[prop]) {
$pr('***+++', (base.name || base.constructor.name + ' o'), prop);
...
//$pr('***===', (base.name || base.constructor.name + ' o'), prop);
  ...
  function extend(name, proto, statics) {
    ...
    copy(ctor, {}, statics,
        _super !== Object ? {super_:_super, 'super':_super} : null,
