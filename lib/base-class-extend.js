...
(function () {
  ...
  function BaseClass_extend(name, proto, classProps) {
    ...
    if (!('private' in proto)) proto.private = BaseClass_addPrototype;
  ...
  // BaseClass_addPrototype
  function BaseClass_addPrototype(proto) {
  ...
  var BaseClass = BaseClass_extend('BaseClass',
                    {'private':     BaseClass_addPrototype,
                     addPrototype : BaseClass_addPrototype,
