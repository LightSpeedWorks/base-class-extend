...
this.BaseClass = function () {
  ...
  function namedFunc(name, fn) {
    ...
    try { fn.name = name; return fn; } catch (err) {}
    try {
  ...
  function Base_create() {
    var ctor = typeof this === 'function' ? this : Object;
    var _super = ctor.super_ || Object;
    var superProto = _super === Object ? Function.prototype : _super.prototype;

    function __() { this.constructor = _super; }

    if (ctor === Object) return Object.apply(null, arguments);
  ...
  function Base_extend(name, proto, props) {
    ...
    proto = ctor.prototype; // nishizawa add
